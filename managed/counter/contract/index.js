...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        if (!(typeof(incrementBy_0) === 'bigint' && incrementBy_0 >= 0 && incrementBy_0 <= __compactRuntime.MAX_FIELD)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(incrementBy_0),
  ...
  _increment_0(context, partialProofData, incrementBy_0) {
    const currentValue_0 = _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                     partialProofData,
                                                                                     [
                                                                                      { dup: { n: 0 } },
                                                                                      { idx: { cached: false,
    ...
    const nextValue_0 = __compactRuntime.addField(currentValue_0, incrementBy_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nextValue_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
